...
function MovieCard({ item, isBookmarked, onToggleBookmark, isWholeSeason }) {
  ...
  return (
    <div className="card group max-w-[240px] mx-auto bg-white/95 dark:bg-gray-800/95 rounded-xl border border-gray-100 dark:border-gray-700 hover:scale-105 transition-all duration-200 cursor-pointer p-3 sm:p-0">
      <div className="w-full aspect-[2/3] bg-gray-100 dark:bg-gray-700 rounded-xl mb-3 border border-gray-200 dark:border-gray-700 flex items-center justify-center overflow-hidden">
  <img
    src={
    ...
    alt={item.Title}
    className="w-full h-full object-cover transition-all duration-200 group-hover:brightness-90 group-hover:scale-105"
    onError={(e) => {
      e.target.src =
